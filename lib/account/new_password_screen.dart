...
class _NewPasswordScreenState extends ConsumerState<NewPasswordScreen> {
  ...
  void initState() {
    super.initState();
    ref.listenManual(changePasswordProvider, (previous, next) {
                            ...
                            onPressed: (snapshot.connectionState == ConnectionState.waiting)
                                ...
                                : () {
                                    if (_formKey.currentState!.validate() && (passwordController1.text.trim() == passwordController2.text.trim())) {
                                      pendingFetch.value = ref.read(changePasswordProvider.notifier).fetch(passwordController1.text.trim());
                                    }
                                  },
                            child: Row(

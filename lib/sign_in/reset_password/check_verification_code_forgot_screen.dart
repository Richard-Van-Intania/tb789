...
class _CheckVerificationCodeForgotScreenState extends ConsumerState<CheckVerificationCodeForgotScreen> {
  ...
  void initState() {
    super.initState();
    ref.listenManual(checkVerificationCodeForgotProvider, (previous, next) {
      next.whenData((data) {
                        ...
                        onPressed: (snapshot.connectionState == ConnectionState.waiting)
                            ...
                            : () {
                                if (_formFieldKey.currentState!.validate()) {
                                  pendingFetch.value = ref.read(checkVerificationCodeForgotProvider.notifier).fetch(int.parse(codeController.text.trim().replaceAll(regInt, '')));
                                }
                              },
                        child: Row(
